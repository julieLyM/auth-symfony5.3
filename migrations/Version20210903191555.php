 ...
 */
final class Version20210903191555 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD users_id INT NOT NULL, ADD categories_id INT NOT NULL, ADD slug VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP users_id, DROP categories_id, DROP slug');
    }
}
